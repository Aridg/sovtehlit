package code.hibernate.directories.views;
 ...
 */
@Entity
@Table(name = "MaterialsV", schema = "sovtehlit")
public class MaterialVEntity implements IModel{
    private int id;
    private String name;
    private String type;
    ...
    public boolean equals(Object o) {
        ...
        MaterialVEntity that = (MaterialVEntity) o;
